...
Un utilisateur A reçoit une distribution de cartes cadeaux d'un montant de 100 euros de la part de son company. il disposera donc de 100 € de cartes cadeaux sur son compte.
...
* Implémentez la fonction de distribution des cartes-cadeaux à l'utilisateur par l'company si le solde de l'company le permet.
